...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "is_active", sa.Boolean(), nullable=False, comment="Account active status"
        ),
        sa.Column(
            "is_verified",
            sa.Boolean(),
        ...
        sa.Column(
            "is_superuser", sa.Boolean(), nullable=False, comment="Admin/superuser flag"
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_users_username_active", "users", ["username", "is_active"], unique=False
    )
    ...
    op.create_index(
        "ix_token_blacklist_jti_expires",
        "token_blacklist",
        ["jti", "expires_at"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_refresh_tokens_is_revoked", "refresh_tokens", ["is_revoked"], unique=False
    )
    op.create_index(
